	...
	public class SvgScripts
	{
		private static Lazy<ResourceManager> _resourceManager =
			new Lazy<ResourceManager>(() => new ResourceManager(
				"Tessin.Bladerunner.Svg.SvgScripts",
#if NET40
				typeof(SvgScripts).Assembly
#else
				typeof(SvgScripts).GetTypeInfo().Assembly
#endif
			));
		...
		/// <summary>
		/// Looks up a localized string similar to "var tooltips = document.getElementsByName(&quot;tooltip&quot;); var n = tooltips.length; for (var i = 0; i &lt;..."
		/// </summary>
